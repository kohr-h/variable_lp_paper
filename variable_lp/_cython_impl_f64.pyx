...
"""Cython implementation of variable Lp functionality for float64 dtype."""
...
__all__ = ('varlp_prox_factor_f64_c', 'varlp_cc_prox_factor_f64_c',
...
def varlp_prox_factor_f64_c(
    ...
    Signature::
        ...
        void varlp_prox_factor_f64_c(np.ndarray[float64] abs_f,
...
@cython.boundscheck(False)
@cython.wraparound(False)
def varlp_cc_prox_factor_f64_c(
        float_t[:] abs_f,
        float_t[:] p,
        float_t sigma,
        int_t num_newton_iter,
    ...
    Signature::
        ...
        void varlp_cc_prox_factor_f64_c(np.ndarray[float64] abs_f,
                                        np.ndarray[float64] p,
                                        float64 sigma,
                                        int64 num_newton_iter,
                                        np.ndarray[float64] out)
...
def varlp_cc_integrand_f64_c(
    ...
    Signature::
        ...
        void varlp_cc_integrand_f64_c(np.ndarray[float64] abs_f,
                                      np.ndarray[float64] p,
                                      np.ndarray[float64] out)
    """
    cdef:
...
@cython.boundscheck(False)
@cython.wraparound(False)
def varlp_moreau_integrand_f64_c(
        float_t[:] abs_f,
        float_t[:] p,
        float_t sigma,
        int_t num_newton_iter,
    ...
    Signature::
        ...
        void varlp_moreau_integrand_f64_c(np.ndarray[float64] abs_f,
                                          np.ndarray[float64] p,
                                          float64 sigma,
                                          int64 num_newton_iter,
                                          np.ndarray[float64] out)
