...
import odl
from odl.solvers.nonsmooth._varlp.varlp_npy import varlp_moreau_integrand_npy
from odl.solvers.nonsmooth._varlp.varlp_numba import (
    varlp_moreau_integrand_numba)
from odl.solvers.nonsmooth._varlp.varlp_cython import (
    varlp_moreau_integrand_cython)
from odl.solvers.nonsmooth._varlp.varlp_gpuary import (
    varlp_moreau_integrand_gpuary)
