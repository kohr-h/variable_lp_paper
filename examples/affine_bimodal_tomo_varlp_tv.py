...
with open('affine_bimodal_tomo_varlp_tv_fom.txt', 'w+') as f:
...
plt.legend()
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_varlp_tv_profile.png')
...
axes.axis('off')
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_varlp_tv_reco.png')
...
axes.axis('off')
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_varlp_tv_exp.png')
...
axes.axis('off')
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_good_data.png')
...
axes.axis('off')
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_bad_data.png')
