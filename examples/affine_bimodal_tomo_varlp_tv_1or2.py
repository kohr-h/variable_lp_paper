...
exponent = reco_space.one()
exponent[conv_abs_lapl.asarray() < 1] = 2
exponent.show()
...
with open('affine_bimodal_tomo_varlp_tv_1or2_fom.txt', 'w+') as f:
...
plt.legend()
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_varlp_tv_1or2_profile.png')
...
axes.axis('off')
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_varlp_tv_1or2_reco.png')
...
axes.axis('off')
plt.tight_layout()
plt.savefig('affine_bimodal_tomo_varlp_tv_1or2_exp.png')
