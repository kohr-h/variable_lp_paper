"""Bimodal tomography with variable Lp TV regularizer (bad data only)."""
...
pre_kernel = reco_space.element(exp_kernel, s=0.01)
...
abs_lapl[:, -8:] = 0
# Post-smoothing
post_kernel = reco_space.element(exp_kernel, s=0.04)
...
with open('affine_bimodal_tomo_varlp_tv_bootstrap_fom.txt', 'w+') as f:
